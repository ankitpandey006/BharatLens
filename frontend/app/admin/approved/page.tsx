...
export default function ApprovedPage() {
  ...
  useEffect(() => {
    void fetchAdminItemsByStatus("approved")
      .then(setItems)
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-[#1A3C6E]">Approved Items</h1>
        <p className="mt-2 text-[#111827]/60">
          Items that are approved and ready for publishing workflows.
        </p>
      </div>
