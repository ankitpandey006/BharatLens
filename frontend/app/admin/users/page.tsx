  ...
  return (
    <div className="space-y-8">
      ...
      {error ? (
        ...
        <div className="rounded-2xl border border-[#E5E7EB] bg-white p-8 text-center text-[#111827]/60">
          No users found.
        </div>
      ) : (
        <>
            ...
            {users.map((user) => (
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  <span className="shrink-0 rounded-md bg-[#F5F3EE] px-2.5 py-1 text-xs font-medium text-[#1A3C6E]">
                    {user.role}
                  </span>
                </div>
